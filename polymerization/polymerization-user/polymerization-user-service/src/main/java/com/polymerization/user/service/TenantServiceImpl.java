...
import com.polymerization.common.util.MD5Util;
...
import com.polymerization.user.api.ResourceService;
...
//////////////////////////////////////////租户相关的操作///////////////////////////////////////////////////
    ...
    public TenantDTO createTenantAndAccount(CreateTenantRequestDTO createTenantRequest) throws BusinessException {
        ...
        if (isExistAccountByMobile(mobile)) {//为true表示 手机号已存在
            ...
            if (tenant == null) {
                ...
                BeanUtils.copyProperties(ten, tenantDTO);
                return tenantDTO;
            } else {
                return tenant;
            }
    ...
    @Override
    @Transactional(rollbackFor = Exception.class)
    public TenantDTO createTenantRelateAccount(CreateTenantRequestDTO createTenantRequest) throws BusinessException {
     ...
     */
    @Override
    public void removeTenant(Long id) throws BusinessException {
        //预留接口，暂不实现
    }
     ...
     */
    @Override
    public PageVO<TenantDTO> queryTenants(TenantQueryDTO tenantQuery, Integer pageNo, Integer pageSize, String sortBy, String order) throws BusinessException {
     ...
     */
    @Override
    public List<BundleDTO> queryBundleByTenantType(String tenantType) throws BusinessException {
        ...
        List<BundleDTO> dtoList = new ArrayList<>();//BundleConvert.INSTANCE.entitylist2dto(bundles);
        for (Bundle bundle : bundles) {
            BundleDTO bundleDTO = new BundleDTO();
            BeanUtils.copyProperties(bundle, bundleDTO);
            dtoList.add(bundleDTO);
        }
        return dtoList;
    }
     ...
     */
    @Override
    public BundleDTO getBundle(String bundleCode) throws BusinessException {
        QueryWrapper<Bundle> qw = new QueryWrapper<>();
     ...
     */
    @Override
    public List<BundleDTO> queryAllBundle() throws BusinessException {
     ...
     */
    @Override
    public void changeBundle(Long tenantId, String bundleCode) throws BusinessException {
        //查询租户下所有的角色
     ...
     */
    @Override
    public void initBundle(Long tenantId, String bundleCode) throws BusinessException {
        //设置套餐
...
//            List<AuthorizationRole> roles = AuthorizationRoleConvert.INSTANCE.dtolist2entity(roleDTOList);
            ...
            for (RoleDTO roleDTO : roleDTOList) {
                ...
                BeanUtils.copyProperties(roleDTO, authorizationRole);
     ...
     */
    @Override
    public void createBundle(BundleDTO bundleDTO) throws BusinessException {
        Bundle bundle = new Bundle(); //BundleConvert.INSTANCE.dto2entity(bundleDTO);
     ...
     */
    @Override
    public void modifyBundle(BundleDTO bundleDTO) throws BusinessException {
        Bundle bundle = new Bundle(); //BundleConvert.INSTANCE.dto2entity(bundleDTO);
        BeanUtils.copyProperties(bundleDTO, bundle);
     ...
     */
    @Override
    public void createAccountInTenant(CreateAccountRequestDTO createAccountRequest, Long tenantId) throws BusinessException {
        //1.创建账号
     ...
     */
    @Override
    public AccountDTO createAccount(CreateAccountRequestDTO createAccountRequest) throws BusinessException {
     ...
     */
    @Override
    public boolean accountPassword(ChangeAccountPwdDTO accountRequest) throws BusinessException {
     ...
     * @param isAdmin
     */
    public void bindTenantAccount(Long tenantId, Long accountId, Boolean isAdmin) throws BusinessException {
        //设置为管理员，需要在创建租户时传值过来
     ...
     */
    @Override
    public void unbindTenant(Long tenantId, String username) throws BusinessException {
        //1.租户内非管理员账号
     ...
     */
    @Override
    public boolean isExistAccountByUsername(String username) throws BusinessException {
     ...
     */
    @Override
    public boolean isExistAccountByMobile(String mobile) throws BusinessException {
        log.info("判断手机号在账号中是否存在");
        int i = accountMapper.selectAccountByMobile(mobile);
//        Integer i = accountMapper.selectCount(new LambdaQueryWrapper<Account>().eq(Account::getMobile, mobile));
        return i > 0;
    }
     ...
     */
    @Override
    public AccountDTO getAccountByUsername(String username) throws BusinessException {
        QueryWrapper<Account> qw = new QueryWrapper<>();
        qw.lambda().eq(Account::getUsername, username);
        Account account = accountMapper.selectOne(qw);
     ...
     */
    @Override
    public AccountDTO getAccountByMobile(String mobile) throws BusinessException {
        QueryWrapper<Account> qw = new QueryWrapper<>();
     ...
     */
    @Override
    public boolean isExistAccountInTenantByUsername(Long tenantId, String username) throws BusinessException {
     ...
     */
    @Override
    public boolean isExistAccountInTenantByMobile(Long tenantId, String mobile) throws BusinessException {
     ...
     */
    @Override
    public PageVO<AccountDTO> queryAccount(AccountQueryDTO accountQuery, Integer pageNo, Integer pageSize, String sortBy, String order) throws BusinessException {
     ...
     */
    @Override
    public List<TenantDTO> queryAccountInTenant(String username) throws BusinessException {
        AccountDTO accountDTO = getAccountByUsername(username);
     ...
     */
    @Override
    public String sendMessage(String phone) throws BusinessException {
     ...
     */
    private Map verificationMessageCode(String smsKey, String passwordOrMessage) throws BusinessException {
     ...
     */
    @Override
    public AccountDTO authentication(AuthenticationInfo authenticationInfo) throws BusinessException {
     ...
     */
    @Override
    public LoginInfoDTO login(LoginRequestDTO loginRequest) throws BusinessException {
...
//            loginInfo.setResources(resources);
     ...
     */
    @Override
    public ApplicationDTO getApplicationDTOByClientId(String clientId) throws BusinessException {
        ...
        BeanUtils.copyProperties(resourceApplication, applicationDTO);
    ...
    @Override
    public AccountRoleQueryDTO queryAccountRole(String username, String roleCode, Long tenantId) throws BusinessException {
        AccountRoleQueryDTO accountRole = tenantAccountMapper.selectAccountRole(username, roleCode, tenantId);
        return accountRole;
    }

    @Override
    public PageVO<AccountRoleQueryDTO> queryAdministratorByPage(AccountRoleDTO query, Integer pageNo, Integer pageSize) throws BusinessException {
