package com.polymerization.merchant.common.utils;
...
//	}
	...
	public static Long getMerchantId(){
		MerchantService merchantService = com.polymerization.merchant.common.intercept.utils.ApplicationContextHelper.getBean(MerchantService.class);
