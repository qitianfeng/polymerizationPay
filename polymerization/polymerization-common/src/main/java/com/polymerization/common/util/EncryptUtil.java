...
public class EncryptUtil {
    ...
    public static void main(String [] args){
        ...
        token.put("mobile","111111111111111123123");
        token.put("merchantId","2312312312");
        token.put("username","111111111111111");
        String encoded2 = EncryptUtil.encodeUTF8StringBase64(JSON.toJSONString(token));
