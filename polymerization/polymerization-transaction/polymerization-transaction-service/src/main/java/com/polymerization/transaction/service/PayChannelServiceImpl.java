...
import com.polymerization.common.util.RedisUtil;
...
import com.polymerization.transaction.mapper.PayChannelParamMapper;
import com.polymerization.transaction.mapper.AppPlatformChannelMapper;
import com.polymerization.transaction.mapper.PlatformChannelMapper;
...
public class PayChannelServiceImpl implements PayChannelService {
    ...
    public void savePayChannelParam(PayChannelParamDTO payChannelParam) throws BusinessException {
        ...
        if(entity != null){
            ...
            //否则添加配置
            PayChannelParam entityNew = new PayChannelParam();
            BeanUtils.copyProperties(payChannelParam,entityNew);
    ...
    private void updateCache(String appId,String platformChannelCode){
        ...
        if(appPlatformChannelId != null){
            ...
            List<PayChannelParamDTO> platformChannels = new ArrayList<>();
            for (PayChannelParam payChannelParam : payChannelParams) {
                ...
                platformChannels.add(payChannelParam1);
            }
            //将payChannelParamDTOS转成json串存入redis
            cache.set(redisKey, JSON.toJSON(platformChannels).toString());
        }
